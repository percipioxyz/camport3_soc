...
// Logger.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/Logger.h#5 $
//
// Library: Foundation
// Package: Logging
// Module:  Logger
...
class Foundation_API Logger: public Channel
	...
	/// Variants of these macros that allow message formatting with Percipio::format()
	/// are also available. Up to four arguments are supported.
	///
	/// Examples:
	///     percipio_warning(logger, "This is a warning");
	///     percipio_information_f2(logger, "An informational message with args: %d, %d", 1, 2);
{
public:
...
// convenience macros
//
#define percipio_fatal(logger, msg) \
	if ((logger).fatal()) (logger).fatal(msg, __FILE__, __LINE__); else (void) 0

#define percipio_fatal_f1(logger, fmt, arg1) \
	if ((logger).fatal()) (logger).fatal(Percipio::format((fmt), arg1), __FILE__, __LINE__); else (void) 0

#define percipio_fatal_f2(logger, fmt, arg1, arg2) \
	if ((logger).fatal()) (logger).fatal(Percipio::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); else (void) 0

#define percipio_fatal_f3(logger, fmt, arg1, arg2, arg3) \
	if ((logger).fatal()) (logger).fatal(Percipio::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); else (void) 0

#define percipio_fatal_f4(logger, fmt, arg1, arg2, arg3, arg4) \
	if ((logger).fatal()) (logger).fatal(Percipio::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); else (void) 0

#define percipio_critical(logger, msg) \
	if ((logger).critical()) (logger).critical(msg, __FILE__, __LINE__); else (void) 0

#define percipio_critical_f1(logger, fmt, arg1) \
	if ((logger).critical()) (logger).critical(Percipio::format((fmt), (arg1)), __FILE__, __LINE__); else (void) 0

#define percipio_critical_f2(logger, fmt, arg1, arg2) \
	if ((logger).critical()) (logger).critical(Percipio::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); else (void) 0

#define percipio_critical_f3(logger, fmt, arg1, arg2, arg3) \
	if ((logger).critical()) (logger).critical(Percipio::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); else (void) 0

#define percipio_critical_f4(logger, fmt, arg1, arg2, arg3, arg4) \
	if ((logger).critical()) (logger).critical(Percipio::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); else (void) 0

#define percipio_error(logger, msg) \
	if ((logger).error()) (logger).error(msg, __FILE__, __LINE__); else (void) 0

#define percipio_error_f1(logger, fmt, arg1) \
	if ((logger).error()) (logger).error(Percipio::format((fmt), (arg1)), __FILE__, __LINE__); else (void) 0

#define percipio_error_f2(logger, fmt, arg1, arg2) \
	if ((logger).error()) (logger).error(Percipio::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); else (void) 0

#define percipio_error_f3(logger, fmt, arg1, arg2, arg3) \
	if ((logger).error()) (logger).error(Percipio::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); else (void) 0

#define percipio_error_f4(logger, fmt, arg1, arg2, arg3, arg4) \
	if ((logger).error()) (logger).error(Percipio::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); else (void) 0

#define percipio_warning(logger, msg) \
	if ((logger).warning()) (logger).warning(msg, __FILE__, __LINE__); else (void) 0

#define percipio_warning_f1(logger, fmt, arg1) \
	if ((logger).warning()) (logger).warning(Percipio::format((fmt), (arg1)), __FILE__, __LINE__); else (void) 0

#define percipio_warning_f2(logger, fmt, arg1, arg2) \
	if ((logger).warning()) (logger).warning(Percipio::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); else (void) 0

#define percipio_warning_f3(logger, fmt, arg1, arg2, arg3) \
	if ((logger).warning()) (logger).warning(Percipio::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); else (void) 0

#define percipio_warning_f4(logger, fmt, arg1, arg2, arg3, arg4) \
	if ((logger).warning()) (logger).warning(Percipio::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); else (void) 0
	
#define percipio_notice(logger, msg) \
	if ((logger).notice()) (logger).notice(msg, __FILE__, __LINE__); else (void) 0

#define percipio_notice_f1(logger, fmt, arg1) \
	if ((logger).notice()) (logger).notice(Percipio::format((fmt), (arg1)), __FILE__, __LINE__); else (void) 0

#define percipio_notice_f2(logger, fmt, arg1, arg2) \
	if ((logger).notice()) (logger).notice(Percipio::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); else (void) 0

#define percipio_notice_f3(logger, fmt, arg1, arg2, arg3) \
	if ((logger).notice()) (logger).notice(Percipio::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); else (void) 0

#define percipio_notice_f4(logger, fmt, arg1, arg2, arg3, arg4) \
	if ((logger).notice()) (logger).notice(Percipio::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); else (void) 0

#define percipio_information(logger, msg) \
	if ((logger).information()) (logger).information(msg, __FILE__, __LINE__); else (void) 0

#define percipio_information_f1(logger, fmt, arg1) \
	if ((logger).information()) (logger).information(Percipio::format((fmt), (arg1)), __FILE__, __LINE__); else (void) 0

#define percipio_information_f2(logger, fmt, arg1, arg2) \
	if ((logger).information()) (logger).information(Percipio::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); else (void) 0

#define percipio_information_f3(logger, fmt, arg1, arg2, arg3) \
	if ((logger).information()) (logger).information(Percipio::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); else (void) 0

#define percipio_information_f4(logger, fmt, arg1, arg2, arg3, arg4) \
	if ((logger).information()) (logger).information(Percipio::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); else (void) 0

#if defined(_DEBUG) || defined(PERCIPIO_LOG_DEBUG)
	#define percipio_debug(logger, msg) \
		if ((logger).debug()) (logger).debug(msg, __FILE__, __LINE__); else (void) 0

	#define percipio_debug_f1(logger, fmt, arg1) \
		if ((logger).debug()) (logger).debug(Percipio::format((fmt), (arg1)), __FILE__, __LINE__); else (void) 0

	#define percipio_debug_f2(logger, fmt, arg1, arg2) \
		if ((logger).debug()) (logger).debug(Percipio::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); else (void) 0

	#define percipio_debug_f3(logger, fmt, arg1, arg2, arg3) \
		if ((logger).debug()) (logger).debug(Percipio::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); else (void) 0

	#define percipio_debug_f4(logger, fmt, arg1, arg2, arg3, arg4) \
		if ((logger).debug()) (logger).debug(Percipio::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); else (void) 0

	#define percipio_trace(logger, msg) \
		if ((logger).trace()) (logger).trace(msg, __FILE__, __LINE__); else (void) 0

	#define percipio_trace_f1(logger, fmt, arg1) \
		if ((logger).trace()) (logger).trace(Percipio::format((fmt), (arg1)), __FILE__, __LINE__); else (void) 0

	#define percipio_trace_f2(logger, fmt, arg1, arg2) \
		if ((logger).trace()) (logger).trace(Percipio::format((fmt), (arg1), (arg2)), __FILE__, __LINE__); else (void) 0

	#define percipio_trace_f3(logger, fmt, arg1, arg2, arg3) \
		if ((logger).trace()) (logger).trace(Percipio::format((fmt), (arg1), (arg2), (arg3)), __FILE__, __LINE__); else (void) 0

	#define percipio_trace_f4(logger, fmt, arg1, arg2, arg3, arg4) \
		if ((logger).trace()) (logger).trace(Percipio::format((fmt), (arg1), (arg2), (arg3), (arg4)), __FILE__, __LINE__); else (void) 0
#else
	#define percipio_debug(logger, msg)
	#define percipio_debug_f1(logger, fmt, arg1)
	#define percipio_debug_f2(logger, fmt, arg1, arg2)
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_FATAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_FATAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_FATAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_FATAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_FATAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_FATAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_CRITICAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_CRITICAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_CRITICAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_CRITICAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_CRITICAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_CRITICAL);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_ERROR);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_ERROR);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_ERROR);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_ERROR);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_ERROR);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_ERROR);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_WARNING);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_WARNING);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_WARNING);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_WARNING);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_WARNING);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_WARNING);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_NOTICE);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_NOTICE);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_NOTICE);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_NOTICE);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_NOTICE);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_NOTICE);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_INFORMATION);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_INFORMATION);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_INFORMATION);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_INFORMATION);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_INFORMATION);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_INFORMATION);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_DEBUG);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_DEBUG);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_DEBUG);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_DEBUG);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_DEBUG);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_DEBUG);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5), Message::PRIO_TRACE);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6), Message::PRIO_TRACE);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7), Message::PRIO_TRACE);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8), Message::PRIO_TRACE);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9), Message::PRIO_TRACE);
}
...
{
	log(Percipio::format(fmt, value1, value2, value3, value4, value5, value6, value7, value8, value9, value10), Message::PRIO_TRACE);
}
