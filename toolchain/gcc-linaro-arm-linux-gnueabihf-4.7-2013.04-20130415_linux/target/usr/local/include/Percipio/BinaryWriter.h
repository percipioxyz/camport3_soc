...
// BinaryWriter.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/BinaryWriter.h#2 $
//
// Library: Foundation
// Package: Streams
...
#include "Percipio/MemoryStream.h"
#include <vector>
#include <ostream>
...
public:
	...
	BinaryWriter(std::ostream& ostr, TextEncoding& encoding, StreamByteOrder byteOrder = NATIVE_BYTE_ORDER);
		...
		/// (see Percipio::TextEncoding::global()) to the specified encoding.
	...
	{
		Percipio::UInt32 size(static_cast<Percipio::UInt32>(value.size()));
