...
// SharedMemoryImpl.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/SharedMemory_DUMMY.h#1 $
//
// Library: Foundation
// Package: Processes
...
public:
	...
	SharedMemoryImpl(const Percipio::File& aFile, SharedMemory::AccessMode mode, const void* addr);
