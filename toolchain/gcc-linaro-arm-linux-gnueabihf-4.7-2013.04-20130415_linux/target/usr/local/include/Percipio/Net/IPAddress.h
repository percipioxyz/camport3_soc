...
// IPAddress.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/IPAddress.h#2 $
//
// Library: Net
// Package: NetCore
// Module:  IPAddress
...
#include "Percipio/Net/IPAddressImpl.h"
...
public:
	...
	{
		IPv4 = Percipio::Net::Impl::IPAddressImpl::IPv4
#ifdef PERCIPIO_HAVE_IPv6
		,IPv6 = Percipio::Net::Impl::IPAddressImpl::IPv6
#endif
	};
	...
	IPAddress(const void* addr, percipio_socklen_t length);
		/// Creates an IPAddress from a native internet address.
		/// A pointer to a in_addr or a in6_addr structure may be 
		/// passed.

	IPAddress(const void* addr, percipio_socklen_t length, Percipio::UInt32 scope);
		/// Creates an IPAddress from a native internet address.
		/// A pointer to a in_addr or a in6_addr structure may be 
  ...
  static uint32_t toInt(const IPAddress& addr);
    /// Convert a IPv4 address to uint32_t.

  static IPAddress fromInt(uint32_t);
    /// Convert a IPv4 address from uint32_t.

  static IPAddress localIP();
    /// Retruns a IP of local host.
...
private:
	typedef Percipio::Net::Impl::IPAddressImpl Impl;
	...
	void newIPv6(const void* hostAddr, Percipio::UInt32 scope);
	...
	char* storage();
		...
		static const unsigned sz = sizeof(Percipio::Net::Impl::IPv6AddressImpl);
		...
		AlignedCharArrayUnion <Percipio::Net::Impl::IPv6AddressImpl>
...
{
#ifdef PERCIPIO_HAVE_ALIGNMENT
	new (storage()) Percipio::Net::Impl::IPv4AddressImpl(hostAddr);
#else
	_pImpl = new Percipio::Net::Impl::IPv4AddressImpl(hostAddr);
#endif
}
...
{
#ifdef PERCIPIO_HAVE_ALIGNMENT
	new (storage()) Percipio::Net::Impl::IPv6AddressImpl(hostAddr);
#else
	_pImpl = new Percipio::Net::Impl::IPv6AddressImpl(hostAddr);
#endif
}


inline void IPAddress::newIPv6(const void* hostAddr, Percipio::UInt32 scope)
{
#ifdef PERCIPIO_HAVE_ALIGNMENT
	new (storage()) Percipio::Net::Impl::IPv6AddressImpl(hostAddr, scope);
#else
	_pImpl = new Percipio::Net::Impl::IPv6AddressImpl(hostAddr, scope);
#endif
}
...
{
#ifdef PERCIPIO_HAVE_ALIGNMENT
	new (storage()) Percipio::Net::Impl::IPv4AddressImpl(prefix);
#else
	_pImpl = new Percipio::Net::Impl::IPv4AddressImpl(prefix);
#endif
}
...
{
#ifdef PERCIPIO_HAVE_ALIGNMENT
	new (storage()) Percipio::Net::Impl::IPv6AddressImpl(prefix);
#else
	_pImpl = new Percipio::Net::Impl::IPv6AddressImpl(prefix);
#endif
}
...
{
#ifdef PERCIPIO_HAVE_ALIGNMENT
	new (storage()) Percipio::Net::Impl::IPv4AddressImpl;
#else
	_pImpl = new Percipio::Net::Impl::IPv4AddressImpl;
#endif
}
...
{
#ifdef PERCIPIO_HAVE_ALIGNMENT
	new (storage()) Percipio::Net::Impl::IPv6AddressImpl;
#else
	_pImpl = new Percipio::Net::Impl::IPv6AddressImpl;
#endif
}
