...
// HTTPSession.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/HTTPSession.h#2 $
//
// Library: Net
// Package: HTTP
// Module:  HTTPSession
...
public:
	...
	Percipio::Timespan getTimeout() const;
	...
	const Percipio::Exception* networkException() const;
	...
	void attachSessionData(const Percipio::Any& data);
	...
	const Percipio::Any& sessionData() const;
		/// Returns the data attached with attachSessionData(),
		/// or an empty Percipio::Any if no user data has been
		/// attached.
...
protected:
	...
	void setException(const Percipio::Exception& exc);
...
private:
	...
	Percipio::Exception* _pException;
	Percipio::Any        _data;
...
inline Percipio::Timespan HTTPSession::getTimeout() const
{
	return _timeout;
}
...
inline const Percipio::Exception* HTTPSession::networkException() const
{
	return _pException;
}
...
inline const Percipio::Any& HTTPSession::sessionData() const
{
	return _data;
}
