...
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/HTTPSessionInstantiator.h#1 $
//
// Library: Net
// Package: HTTPClient
...
public:
	...
	virtual HTTPClientSession* createClientSession(const Percipio::URI& uri);
...
protected:
	void setProxy(const std::string& host, Percipio::UInt16 port);
...
inline Percipio::UInt16 HTTPSessionInstantiator::proxyPort() const
{
	return _proxyPort;
}
