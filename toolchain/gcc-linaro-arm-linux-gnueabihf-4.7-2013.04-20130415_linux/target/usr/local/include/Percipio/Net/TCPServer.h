...
// TCPServer.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/TCPServer.h#1 $
//
// Library: Net
// Package: TCPServer
// Module:  TCPServer
...
class Net_API TCPServer: public Percipio::Runnable
...
{
public:
	TCPServer(TCPServerConnectionFactory::Ptr pFactory, Percipio::UInt16 portNumber = 0, TCPServerParams::Ptr pParams = 0);
	...
	TCPServer(TCPServerConnectionFactory::Ptr pFactory, Percipio::ThreadPool& threadPool, const ServerSocket& socket, TCPServerParams::Ptr pParams = 0);
		/// Creates the TCPServer, using the given ServerSocket.
		///
		/// The server takes ownership of the TCPServerConnectionFactory
		/// and deletes it when it's no longer needed.
...
inline Percipio::UInt16 TCPServer::port() const
{
