...
// HTTPMessage.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/HTTPMessage.h#3 $
//
// Library: Net
// Package: HTTP
// Module:  HTTPMessage
...
public:
	...
	void setContentLength64(Percipio::Int64 length);
		/// Sets the Content-Length header.
		///
		/// If length is UNKNOWN_CONTENT_LENGTH, removes
		/// the Content-Length header.
	...
	Percipio::Int64 getContentLength64() const;
		/// Returns the content length for this message,
		/// which may be UNKNOWN_CONTENT_LENGTH if
		/// no Content-Length header is present.
		///
...
#endif // defined(PERCIPIO_HAVE_INT64)
