...
// HTTPServer.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/HTTPServer.h#1 $
//
// Library: Net
// Package: HTTPServer
// Module:  HTTPServer
...
#include "Percipio/Net/TCPServer.h"
...
{
public:
	HTTPServer(HTTPRequestHandlerFactory::Ptr pFactory, Percipio::UInt16 portNumber = 80, HTTPServerParams::Ptr pParams = new HTTPServerParams);
	...
	HTTPServer(HTTPRequestHandlerFactory::Ptr pFactory, Percipio::ThreadPool& threadPool, const ServerSocket& socket, HTTPServerParams::Ptr pParams);
		/// Creates the HTTPServer, using the given ServerSocket.
		///
		/// The server takes ownership of the HTTPRequstHandlerFactory
		/// and deletes it when it's no longer needed.
