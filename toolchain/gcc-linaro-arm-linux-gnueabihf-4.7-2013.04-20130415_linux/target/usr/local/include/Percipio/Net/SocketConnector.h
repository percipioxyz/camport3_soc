...
// SocketConnector.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/SocketConnector.h#1 $
//
// Library: Net
// Package: Reactor
...
public:		
	...
	{
		_pReactor = &reactor;
		_pReactor->addEventHandler(_socket, Percipio::Observer<SocketConnector, ReadableNotification>(*this, &SocketConnector::onReadable));
		_pReactor->addEventHandler(_socket, Percipio::Observer<SocketConnector, WritableNotification>(*this, &SocketConnector::onWritable));
		_pReactor->addEventHandler(_socket, Percipio::Observer<SocketConnector, ErrorNotification>(*this, &SocketConnector::onError));
	}
		...
		/// The overriding method must call the baseclass implementation first.
	{
		if (_pReactor)
		{
			_pReactor->removeEventHandler(_socket, Percipio::Observer<SocketConnector, ReadableNotification>(*this, &SocketConnector::onReadable));
			_pReactor->removeEventHandler(_socket, Percipio::Observer<SocketConnector, WritableNotification>(*this, &SocketConnector::onWritable));
			_pReactor->removeEventHandler(_socket, Percipio::Observer<SocketConnector, ErrorNotification>(*this, &SocketConnector::onError));
		}
	}
