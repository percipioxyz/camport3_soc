...
// FTPStreamFactory.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/FTPStreamFactory.h#1 $
//
// Library: Net
// Package: FTP
...
class Net_API FTPStreamFactory: public Percipio::URIStreamFactory
...
public:
	...
	std::istream* open(const Percipio::URI& uri);
...
protected:
	...
	static void getUserInfo(const Percipio::URI& uri, std::string& username, std::string& password);
	static void getPathAndType(const Percipio::URI& uri, std::string& path, char& type);
