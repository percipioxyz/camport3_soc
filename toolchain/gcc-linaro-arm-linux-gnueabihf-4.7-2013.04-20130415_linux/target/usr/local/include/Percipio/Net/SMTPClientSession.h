...
// SMTPClientSession.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/SMTPClientSession.h#1 $
//
// Library: Net
// Package: Mail
...
#include "Percipio/Net/DialogSocket.h"
...
public:
	...
	SMTPClientSession(const std::string& host, Percipio::UInt16 port = SMTP_PORT);
...
protected:
	...
	void loginUsingCRAM(const std::string& username, const std::string& method, Percipio::DigestEngine& hmac);
