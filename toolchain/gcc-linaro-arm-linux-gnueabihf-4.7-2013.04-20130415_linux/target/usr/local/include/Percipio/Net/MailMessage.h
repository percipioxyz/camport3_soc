...
// MailMessage.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/MailMessage.h#2 $
//
// Library: Net
// Package: Mail
// Module:  MailMessage
...
#include "Percipio/Net/MessageHeader.h"
#include "Percipio/Net/MailRecipient.h"
#include "Percipio/Net/PartStore.h"
...
public:
	...
	void setDate(const Percipio::Timestamp& dateTime);
		/// Sets the Date header to the given date/time value.
		
	Percipio::Timestamp getDate() const;
