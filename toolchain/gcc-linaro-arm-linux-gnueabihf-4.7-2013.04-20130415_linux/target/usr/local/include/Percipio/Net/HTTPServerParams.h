...
// HTTPServerParams.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/HTTPServerParams.h#1 $
//
// Library: Net
// Package: HTTPServer
...
{
public:
	typedef Percipio::AutoPtr<HTTPServerParams> Ptr;
...
inline const Percipio::Timespan& HTTPServerParams::getTimeout() const
{
	return _timeout;
}
...
inline const Percipio::Timespan& HTTPServerParams::getKeepAliveTimeout() const
{
