...
// StreamSocket.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/StreamSocket.h#1 $
//
// Library: Net
// Package: Sockets
// Module:  StreamSocket
...
public:
	...
	void connect(const SocketAddress& address, const Percipio::Timespan& timeout);
	...
	int sendBytes(Percipio::FIFOBuffer& buffer);
		/// Sends the contents of the given buffer through
	...
	int receiveBytes(Percipio::FIFOBuffer& buffer);
		/// Receives data from the socket and stores it
