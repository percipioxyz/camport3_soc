...
// WebSocket.h
//
// $Id: //percipio/1.4/Net/include/Percipio/Net/WebSocket.h#4 $
//
// Library: Net
// Package: WebSocket
// Module:  WebSocket
...
#include "Percipio/Net/HTTPCredentials.h"
...
public:
	...
	WebSocket(const Socket& socket);
		...
		/// otherwise a Percipio::InvalidArgumentException will be thrown.
	...
	WebSocket& operator = (const Socket& socket);
		/// Assignment operator.
		///
		/// The other socket must be a WebSocket, otherwise a Percipio::InvalidArgumentException
		/// will be thrown.
	...
	void shutdown(Percipio::UInt16 statusCode, const std::string& statusMessage = "");
		/// Sends a Close control frame to the server end of
		/// the connection to initiate an orderly shutdown
		/// of the connection.
