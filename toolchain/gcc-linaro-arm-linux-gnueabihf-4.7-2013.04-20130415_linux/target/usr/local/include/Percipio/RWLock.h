...
// RWLock.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/RWLock.h#3 $
//
// Library: Foundation
// Package: Threading
// Module:  RWLock
...
#include "Percipio/RWLock_WINCE.h"
#else
#include "Percipio/RWLock_WIN32.h"
#endif
#elif defined(PERCIPIO_ANDROID)
#include "Percipio/RWLock_Android.h"
#elif defined(PERCIPIO_VXWORKS)
#include "Percipio/RWLock_VX.h"
#else
#include "Percipio/RWLock_POSIX.h"
#endif
