...
// NObserver.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/NObserver.h#2 $
//
// Library: Foundation
...
#include "Percipio/AbstractObserver.h"
...
public:
	...
	{
		Percipio::Mutex::ScopedLock lock(_mutex);
