...
// AbstractEvent.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/AbstractEvent.h#3 $
//
// Library: Foundation
// Package: Events
...
#include "Percipio/ActiveMethod.h"
...
class AbstractEvent
	...
	///
	///     #include "Percipio/PriorityEvent.h"
	///     #include "Percipio/PriorityDelegate.h"
	///
	...
	///     {
	///     public:
	///         Percipio::BasicEvent<int> dataChanged;
	///         
	///         MyData();
	///         ...
	///         void setData(int i);
...
public:
	...
	void notify(const void* pSender, TArgs& args)
		...
		/// to the caller.
	{
		Percipio::ScopedLockWithUnlock<TMutex> lock(_mutex);
