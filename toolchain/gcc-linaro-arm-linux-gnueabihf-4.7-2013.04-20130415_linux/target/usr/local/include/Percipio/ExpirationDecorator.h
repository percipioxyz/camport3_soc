...
//
// $Id: //percipio/1.4/Foundation/include/Percipio/ExpirationDecorator.h#1 $
//
// Library: Foundation
// Package: Events
...
public:
	...
	ExpirationDecorator(const TArgs& p, const Percipio::Timespan::TimeDiff& diffInMs):
	...
	ExpirationDecorator(const TArgs& p, const Percipio::Timespan& timeSpan):
	...
	ExpirationDecorator(const TArgs& p, const Percipio::Timestamp& timeStamp):
