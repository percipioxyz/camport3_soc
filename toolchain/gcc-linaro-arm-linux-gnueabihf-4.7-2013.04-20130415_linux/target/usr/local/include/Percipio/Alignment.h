...
// Alignment.h
//
// $Id: //percipio/svn/Foundation/include/Percipio/Alignment.h#2 $
//
// Library: Foundation
// Package: Dynamic
// Module:  Alignment
...
// Adapted for PERCIPIO from LLVM Compiler Infrastructure code:
//
...
#include <cstddef>
	...
	#include <type_traits>
	#define PERCIPIO_HAVE_ALIGNMENT
	...
	// MSVC requires special handling here.
		...
		#ifdef PERCIPIO_COMPILER_CLANG

			#if __has_feature(cxx_alignas)
				#define PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(x) \
			...
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(1);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(2);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(4);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(8);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(16);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(32);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(64);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(128);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(512);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(1024);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(2048);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(4096);
			PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(8192);

			#undef PERCIPIO_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT
	...
	// PERCIPIO_HAVE_ALIGNMENT will be defined on the pre-C++11 platforms/compilers where
	...
	// #undef PERCIPIO_HAVE_ALIGNMENT
		...
		private:
			Percipio::AlignedCharArrayImpl<AlignOf<AlignerImpl>::Alignment> _nonceMember;
