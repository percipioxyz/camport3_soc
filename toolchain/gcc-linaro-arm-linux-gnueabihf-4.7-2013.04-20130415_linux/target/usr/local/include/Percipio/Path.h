...
// Path.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/Path.h#3 $
//
// Library: Foundation
// Package: Filesystem
// Module:  Path
...
public:
	...
	static std::string transcode(const std::string& path);
		/// On Windows, if PERCIPIO has been compiled with Windows UTF-8 support 
		/// (PERCIPIO_WIN32_UTF8), this function converts a string (usually containing a path) 
		...
		///
		/// On all other platforms, or if PERCIPIO has not been compiled with Windows UTF-8
