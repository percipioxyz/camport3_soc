...
// ListMap.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/ListMap.h#1 $
//
// Library: Foundation
// Package: Hashing
// Module:  ListMap
...
class ListMap
	...
	/// use with large datasets. The main purpose within PERCIPIO is for Internet
...
private:
	...
	{
		if (!CaseSensitive)
			return Percipio::icompare(s1, s2) == 0;
		else
			return s1 == s2;
	}
