...
// FIFOBufferStream.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/FIFOBufferStream.h#1 $
//
// Library: Foundation
// Package: Streams
...
#include "Percipio/BufferedBidirectionalStreamBuf.h"
#include <istream>
#include <ostream>
...
{
public:
	Percipio::BasicEvent<bool>& readable;
	Percipio::BasicEvent<bool>& writable;
