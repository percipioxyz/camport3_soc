...
// String.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/String.h#1 $
//
// Library: Foundation
// Package: Core
// Module:  String
...
#if !defined(PERCIPIO_NO_TEMPLATE_ICOMPARE)
...
{
	percipio_check_ptr (from);
	percipio_check_ptr (to);
