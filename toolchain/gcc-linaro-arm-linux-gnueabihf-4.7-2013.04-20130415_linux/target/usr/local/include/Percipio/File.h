...
// File.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/File.h#3 $
//
// Library: Foundation
// Package: Filesystem
// Module:  File
...
#else
#include "Percipio/File_WIN32U.h"
#endif
#elif defined(PERCIPIO_OS_FAMILY_WINDOWS)
#include "Percipio/File_WIN32.h"
#elif defined(PERCIPIO_VXWORKS)
#include "Percipio/File_VX.h"
#elif defined(PERCIPIO_OS_FAMILY_UNIX)
#include "Percipio/File_UNIX.h"
#else
#include "Percipio/File_VMS.h"
#endif
