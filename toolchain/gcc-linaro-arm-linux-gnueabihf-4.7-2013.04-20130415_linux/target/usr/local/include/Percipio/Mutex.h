...
// Mutex.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/Mutex.h#2 $
//
// Library: Foundation
// Package: Threading
// Module:  Mutex
...
#include "Percipio/Mutex_WINCE.h"
#else
#include "Percipio/Mutex_WIN32.h"
#endif
#elif defined(PERCIPIO_VXWORKS)
#include "Percipio/Mutex_VX.h"
#else
#include "Percipio/Mutex_POSIX.h"
#endif
...
{
public:
	typedef Percipio::ScopedLock<Mutex> ScopedLock;
...
{
public:
	typedef Percipio::ScopedLock<FastMutex> ScopedLock;
...
{
public:
	typedef Percipio::ScopedLock<NullMutex> ScopedLock;
