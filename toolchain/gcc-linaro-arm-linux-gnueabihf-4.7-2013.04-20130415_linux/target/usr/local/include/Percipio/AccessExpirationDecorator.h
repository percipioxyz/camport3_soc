...
//
// $Id: //percipio/1.4/Foundation/include/Percipio/AccessExpirationDecorator.h#2 $
//
// Library: Foundation
// Package: Cache
...
public:
	...
	AccessExpirationDecorator(const TArgs& p, const Percipio::Timespan::TimeDiff& diffInMs):
	...
	AccessExpirationDecorator(const TArgs& p, const Percipio::Timespan& timeSpan):
