...
// UTFString.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/UTFString.h#2 $
//
// Library: Foundation
// Package: Text
// Module:  UTFString
...
//#if defined(PERCIPIO_ENABLE_CPP11) //TODO
	//	typedef char16_t       UTF16Char;
	//	typedef std::u16string UTF16String;
	//	typedef char32_t       UTF32Char;
	//	typedef std::u32string UTF32String;
//#else
	#ifdef PERCIPIO_NO_WSTRING
		typedef Percipio::UInt16                                  UTF16Char;
