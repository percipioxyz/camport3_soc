...
//
// $Id: //percipio/1.4/Foundation/include/Percipio/BufferedBidirectionalStreamBuf.h#1 $
//
// Library: Foundation
// Package: Streams
// Module:  StreamBuf
...
#include "Percipio/BufferAllocator.h"
#include "Percipio/StreamUtil.h"
#include <streambuf>
#include <iosfwd>
#include <ios>
...
//
#if defined(_MSC_VER) && defined(PERCIPIO_DLL) && !defined(Foundation_EXPORTS) 
