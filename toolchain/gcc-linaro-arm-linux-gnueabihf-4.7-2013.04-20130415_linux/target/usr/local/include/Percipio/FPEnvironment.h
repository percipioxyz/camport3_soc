...
// FPEnvironment.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/FPEnvironment.h#1 $
//
// Library: Foundation
// Package: Core
...
#if defined(PERCIPIO_NO_FPENVIRONMENT)
#include "Percipio/FPEnvironment_DUMMY.h"
#elif defined(__osf__) || defined(__VMS)
#include "Percipio/FPEnvironment_DEC.h"
#elif defined(sun) || defined(__sun)
#include "Percipio/FPEnvironment_SUN.h"
#elif defined(PERCIPIO_OS_FAMILY_UNIX)
#include "Percipio/FPEnvironment_C99.h"
#elif defined(PERCIPIO_OS_FAMILY_WINDOWS)
#include "Percipio/FPEnvironment_WIN32.h"
#else
#include "Percipio/FPEnvironment_DUMMY.h"
#endif
