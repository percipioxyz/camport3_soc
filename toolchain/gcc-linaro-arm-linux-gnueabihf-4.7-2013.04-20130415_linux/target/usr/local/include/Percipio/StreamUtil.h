...
// StreamUtil.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/StreamUtil.h#1 $
//
// Library: Foundation
// Package: Streams
// Module:  StreamUtil
...
// the percipio_ios_init macro defined below.


#if !defined(PERCIPIO_IOS_INIT_HACK)
...
#		define PERCIPIO_IOS_INIT_HACK 1
...
#if defined(PERCIPIO_IOS_INIT_HACK)
#	define percipio_ios_init(buf)
#else
#	define percipio_ios_init(buf) init(buf)
#endif
