...
// UnicodeConverter.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/UnicodeConverter.h#1 $
//
// Library: Foundation
// Package: Text
...
public:
	...
	{
		T utfStr;
		Percipio::UnicodeConverter::convert(pChar, utfStr);
		return utfStr;
	}
	...
	{
		T utfStr;
		Percipio::UnicodeConverter::convert(str, utfStr);
		return utfStr;
	}
