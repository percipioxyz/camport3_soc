...
// FileStream.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/FileStream.h#1 $
//
// Library: Foundation
// Package: Streams
// Module:  FileStream
...
#include "Percipio/FileStream_WIN32.h"
#else
#include "Percipio/FileStream_POSIX.h"
#endif
#include <istream>
#include <ostream>
...
class Foundation_API FileIOS: public virtual std::ios
	...
	///
	/// On Windows platforms, if PERCIPIO_WIN32_UTF8 is #define'd,
