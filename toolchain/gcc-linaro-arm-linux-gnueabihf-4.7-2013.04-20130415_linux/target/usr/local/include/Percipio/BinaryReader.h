...
// BinaryReader.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/BinaryReader.h#3 $
//
// Library: Foundation
// Package: Streams
...
public:
	...
	BinaryReader(std::istream& istr, TextEncoding& encoding, StreamByteOrder byteOrder = NATIVE_BYTE_ORDER);
		...
		/// to the currently set global encoding (see Percipio::TextEncoding::global()).
