...
// NumberFormatter.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/NumberFormatter.h#1 $
//
// Library: Foundation
// Package: Core
...
#include "Percipio/NumericString.h"
...
public:
	...
	static const unsigned NF_MAX_FLT_STRING_LEN = PERCIPIO_MAX_FLT_STRING_LEN;
...
#if defined(PERCIPIO_HAVE_INT64) && !defined(PERCIPIO_LONG_IS_64_BIT)
...
#endif // defined(PERCIPIO_HAVE_INT64) && !defined(PERCIPIO_LONG_IS_64_BIT)
...
{
	char buffer[PERCIPIO_MAX_FLT_STRING_LEN];
	floatToStr(buffer, PERCIPIO_MAX_FLT_STRING_LEN, value);
...
{
	char buffer[PERCIPIO_MAX_FLT_STRING_LEN];
	floatToFixedStr(buffer, PERCIPIO_MAX_FLT_STRING_LEN, value, precision);
	return std::string(buffer);
}
...
{
	char buffer[PERCIPIO_MAX_FLT_STRING_LEN];
	doubleToStr(buffer, PERCIPIO_MAX_FLT_STRING_LEN, value);
	return std::string(buffer);
}
...
{
	char buffer[PERCIPIO_MAX_FLT_STRING_LEN];
	doubleToFixedStr(buffer, PERCIPIO_MAX_FLT_STRING_LEN, value, precision);
	return std::string(buffer);
}
