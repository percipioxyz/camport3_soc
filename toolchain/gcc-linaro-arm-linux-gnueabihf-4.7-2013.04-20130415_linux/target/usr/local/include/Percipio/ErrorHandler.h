...
// ErrorHandler.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/ErrorHandler.h#1 $
//
// Library: Foundation
// Package: Threading
// Module:  ErrorHandler
...
public:
	...
	virtual void exception(const Exception& exc);
		/// Called when a Percipio::Exception (or a subclass)
	...
	virtual void exception();
		...
		/// Percipio::Exception nor a std::exception caused
