...
// Platform_VMS.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/Platform_VMS.h#1 $
//
// Library: Foundation
// Package: Core
// Module:  Platform
...
// Our macros work with both 32bit and 64bit pointer sizes.
	...
	#define PERCIPIO_DESCRIPTOR_LITERAL(name, string) \
		struct dsc$descriptor_s name =	\
		{								\
			sizeof(string) - 1,			\
			DSC$K_DTYPE_T,				\
...
#define PERCIPIO_NO_SYS_SELECT_H
