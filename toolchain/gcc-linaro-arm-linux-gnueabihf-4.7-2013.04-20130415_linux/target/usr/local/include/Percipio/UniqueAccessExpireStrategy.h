...
//
// $Id: //percipio/1.4/Foundation/include/Percipio/UniqueAccessExpireStrategy.h#1 $
//
// Library: Foundation
// Package: Cache
...
#include "Percipio/AbstractStrategy.h"
...
class UniqueAccessExpireStrategy: public AbstractStrategy<TKey, TValue>
	...
	///    
	///    const Percipio::Timestamp& getTimeout() const;
	///    
