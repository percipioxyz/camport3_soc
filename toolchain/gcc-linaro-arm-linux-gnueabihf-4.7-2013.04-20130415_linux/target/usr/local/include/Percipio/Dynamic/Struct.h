...
// Struct.h
//
// $Id: //percipio/Main/Foundation/include/Percipio/Dynamic/Struct.h#9 $
//
// Library: Foundation
// Package: Dynamic
// Module:  Struct
...
#include "Percipio/Dynamic/Var.h"
...
public:
	...
	typedef typename Percipio::SharedPtr<Struct<K> > Ptr;
...
public:
	...
	void convert(Percipio::DateTime&) const
	{
		throw BadCastException("Struct -> Percipio::DateTime");
	}

	void convert(Percipio::LocalDateTime&) const
	{
		throw BadCastException("Struct -> Percipio::LocalDateTime");
	}

	void convert(Percipio::Timestamp&) const
	{
		throw BadCastException("Struct -> Percipio::Timestamp");
	}
