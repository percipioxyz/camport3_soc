...
// Pair.h
//
// $Id: //percipio/Main/Foundation/include/Percipio/Dynamic/Pair.h#9 $
//
// Library: Foundation
// Package: Dynamic
// Module:  Pair
...
public:
	...
	{
		throw BadCastException("Pair -> Percipio::DateTime");
	}

	void convert(Percipio::LocalDateTime&) const
	{
		throw BadCastException("Pair -> Percipio::LocalDateTime");
	}

	void convert(Percipio::Timestamp&) const
	{
		throw BadCastException("Pair -> Percipio::Timestamp");
	}
