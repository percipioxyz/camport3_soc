...
// Var.h
//
// $Id: //percipio/svn/Foundation/include/Percipio/Var.h#2 $
//
// Library: Foundation
// Package: Dynamic
// Module:  Var
...
#include "Percipio/Dynamic/VarHolder.h"
#include "Percipio/Dynamic/VarIterator.h"
#include <typeinfo>
...
public:
	...
	typedef Percipio::Dynamic::VarIterator Iterator;
...
inline Percipio::Int8 operator + (const Percipio::Int8& other, const Var& da)
	/// Addition operator for adding Var to Percipio::Int8
{
	return other + da.convert<Percipio::Int8>();
}


inline Percipio::Int8 operator - (const Percipio::Int8& other, const Var& da)
	/// Subtraction operator for subtracting Var from Percipio::Int8
{
	return other - da.convert<Percipio::Int8>();
}
...
inline Percipio::Int8 operator * (const Percipio::Int8& other, const Var& da)
	/// Multiplication operator for multiplying Var with Percipio::Int8
{
	return other * da.convert<Percipio::Int8>();
}
...
inline Percipio::Int8 operator / (const Percipio::Int8& other, const Var& da)
	/// Division operator for dividing Var with Percipio::Int8
{
	return other / da.convert<Percipio::Int8>();
}


inline Percipio::Int8 operator += (Percipio::Int8& other, const Var& da)
	/// Addition asignment operator for adding Var to Percipio::Int8
{
	return other += da.convert<Percipio::Int8>();
}
...
inline Percipio::Int8 operator -= (Percipio::Int8& other, const Var& da)
	/// Subtraction asignment operator for subtracting Var from Percipio::Int8
{
	return other -= da.convert<Percipio::Int8>();
}
...
inline Percipio::Int8 operator *= (Percipio::Int8& other, const Var& da)
	/// Multiplication asignment operator for multiplying Var with Percipio::Int8
{
	return other *= da.convert<Percipio::Int8>();
}
...
inline Percipio::Int8 operator /= (Percipio::Int8& other, const Var& da)
	/// Division asignment operator for dividing Var with Percipio::Int8
{
	return other /= da.convert<Percipio::Int8>();
}


inline bool operator == (const Percipio::Int8& other, const Var& da)
	/// Equality operator for comparing Var with Percipio::Int8
{
	if (da.isEmpty()) return false;
	return other == da.convert<Percipio::Int8>();
}
...
inline bool operator != (const Percipio::Int8& other, const Var& da)
	/// Inequality operator for comparing Var with Percipio::Int8
{
	if (da.isEmpty()) return true;
	return other != da.convert<Percipio::Int8>();
}
...
inline bool operator < (const Percipio::Int8& other, const Var& da)
	/// Less than operator for comparing Var with Percipio::Int8
{
	if (da.isEmpty()) return false;
	return other < da.convert<Percipio::Int8>();
}
...
inline bool operator <= (const Percipio::Int8& other, const Var& da)
	/// Less than or equal operator for comparing Var with Percipio::Int8
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Percipio::Int8>();
}
...
inline bool operator > (const Percipio::Int8& other, const Var& da)
	/// Greater than operator for comparing Var with Percipio::Int8
{
	if (da.isEmpty()) return false;
	return other > da.convert<Percipio::Int8>();
}
...
inline bool operator >= (const Percipio::Int8& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Percipio::Int8
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Percipio::Int8>();
}
...
inline Percipio::UInt8 operator + (const Percipio::UInt8& other, const Var& da)
	/// Addition operator for adding Var to Percipio::UInt8
{
	return other + da.convert<Percipio::UInt8>();
}


inline Percipio::UInt8 operator - (const Percipio::UInt8& other, const Var& da)
	/// Subtraction operator for subtracting Var from Percipio::UInt8
{
	return other - da.convert<Percipio::UInt8>();
}
...
inline Percipio::UInt8 operator * (const Percipio::UInt8& other, const Var& da)
	/// Multiplication operator for multiplying Var with Percipio::UInt8
{
	return other * da.convert<Percipio::UInt8>();
}
...
inline Percipio::UInt8 operator / (const Percipio::UInt8& other, const Var& da)
	/// Division operator for dividing Var with Percipio::UInt8
{
	return other / da.convert<Percipio::UInt8>();
}


inline Percipio::UInt8 operator += (Percipio::UInt8& other, const Var& da)
	/// Addition asignment operator for adding Var to Percipio::UInt8
{
	return other += da.convert<Percipio::UInt8>();
}
...
inline Percipio::UInt8 operator -= (Percipio::UInt8& other, const Var& da)
	/// Subtraction asignment operator for subtracting Var from Percipio::UInt8
{
	return other -= da.convert<Percipio::UInt8>();
}
...
inline Percipio::UInt8 operator *= (Percipio::UInt8& other, const Var& da)
	/// Multiplication asignment operator for multiplying Var with Percipio::UInt8
{
	return other *= da.convert<Percipio::UInt8>();
}
...
inline Percipio::UInt8 operator /= (Percipio::UInt8& other, const Var& da)
	/// Division asignment operator for dividing Var with Percipio::UInt8
{
	return other /= da.convert<Percipio::UInt8>();
}


inline bool operator == (const Percipio::UInt8& other, const Var& da)
	/// Equality operator for comparing Var with Percipio::UInt8
{
	if (da.isEmpty()) return false;
	return other == da.convert<Percipio::UInt8>();
}
...
inline bool operator != (const Percipio::UInt8& other, const Var& da)
	/// Inequality operator for comparing Var with Percipio::UInt8
{
	if (da.isEmpty()) return true;
	return other != da.convert<Percipio::UInt8>();
}
...
inline bool operator < (const Percipio::UInt8& other, const Var& da)
	/// Less than operator for comparing Var with Percipio::UInt8
{
	if (da.isEmpty()) return false;
	return other < da.convert<Percipio::UInt8>();
}
...
inline bool operator <= (const Percipio::UInt8& other, const Var& da)
	/// Less than or equal operator for comparing Var with Percipio::UInt8
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Percipio::UInt8>();
}
...
inline bool operator > (const Percipio::UInt8& other, const Var& da)
	/// Greater than operator for comparing Var with Percipio::UInt8
{
	if (da.isEmpty()) return false;
	return other > da.convert<Percipio::UInt8>();
}
...
inline bool operator >= (const Percipio::UInt8& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Percipio::UInt8
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Percipio::UInt8>();
}
...
inline Percipio::Int16 operator + (const Percipio::Int16& other, const Var& da)
	/// Addition operator for adding Var to Percipio::Int16
{
	return other + da.convert<Percipio::Int16>();
}


inline Percipio::Int16 operator - (const Percipio::Int16& other, const Var& da)
	/// Subtraction operator for subtracting Var from Percipio::Int16
{
	return other - da.convert<Percipio::Int16>();
}
...
inline Percipio::Int16 operator * (const Percipio::Int16& other, const Var& da)
	/// Multiplication operator for multiplying Var with Percipio::Int16
{
	return other * da.convert<Percipio::Int16>();
}
...
inline Percipio::Int16 operator / (const Percipio::Int16& other, const Var& da)
	/// Division operator for dividing Var with Percipio::Int16
{
	return other / da.convert<Percipio::Int16>();
}


inline Percipio::Int16 operator += (Percipio::Int16& other, const Var& da)
	/// Addition asignment operator for adding Var to Percipio::Int16
{
	return other += da.convert<Percipio::Int16>();
}
...
inline Percipio::Int16 operator -= (Percipio::Int16& other, const Var& da)
	/// Subtraction asignment operator for subtracting Var from Percipio::Int16
{
	return other -= da.convert<Percipio::Int16>();
}
...
inline Percipio::Int16 operator *= (Percipio::Int16& other, const Var& da)
	/// Multiplication asignment operator for multiplying Var with Percipio::Int16
{
	return other *= da.convert<Percipio::Int16>();
}
...
inline Percipio::Int16 operator /= (Percipio::Int16& other, const Var& da)
	/// Division asignment operator for dividing Var with Percipio::Int16
{
	return other /= da.convert<Percipio::Int16>();
}


inline bool operator == (const Percipio::Int16& other, const Var& da)
	/// Equality operator for comparing Var with Percipio::Int16
{
	if (da.isEmpty()) return false;
	return other == da.convert<Percipio::Int16>();
}
...
inline bool operator != (const Percipio::Int16& other, const Var& da)
	/// Inequality operator for comparing Var with Percipio::Int16
{
	if (da.isEmpty()) return true;
	return other != da.convert<Percipio::Int16>();
}
...
inline bool operator < (const Percipio::Int16& other, const Var& da)
	/// Less than operator for comparing Var with Percipio::Int16
{
	if (da.isEmpty()) return false;
	return other < da.convert<Percipio::Int16>();
}
...
inline bool operator <= (const Percipio::Int16& other, const Var& da)
	/// Less than or equal operator for comparing Var with Percipio::Int16
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Percipio::Int16>();
}
...
inline bool operator > (const Percipio::Int16& other, const Var& da)
	/// Greater than operator for comparing Var with Percipio::Int16
{
	if (da.isEmpty()) return false;
	return other > da.convert<Percipio::Int16>();
}
...
inline bool operator >= (const Percipio::Int16& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Percipio::Int16
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Percipio::Int16>();
}
...
inline Percipio::UInt16 operator + (const Percipio::UInt16& other, const Var& da)
	/// Addition operator for adding Var to Percipio::UInt16
{
	return other + da.convert<Percipio::UInt16>();
}


inline Percipio::UInt16 operator - (const Percipio::UInt16& other, const Var& da)
	/// Subtraction operator for subtracting Var from Percipio::UInt16
{
	return other - da.convert<Percipio::UInt16>();
}
...
inline Percipio::UInt16 operator * (const Percipio::UInt16& other, const Var& da)
	/// Multiplication operator for multiplying Var with Percipio::UInt16
{
	return other * da.convert<Percipio::UInt16>();
}
...
inline Percipio::UInt16 operator / (const Percipio::UInt16& other, const Var& da)
	/// Division operator for dividing Var with Percipio::UInt16
{
	return other / da.convert<Percipio::UInt16>();
}


inline Percipio::UInt16 operator += (Percipio::UInt16& other, const Var& da)
	/// Addition asignment operator for adding Var to Percipio::UInt16
{
	return other += da.convert<Percipio::UInt16>();
}
...
inline Percipio::UInt16 operator -= (Percipio::UInt16& other, const Var& da)
	/// Subtraction asignment operator for subtracting Var from Percipio::UInt16
{
	return other -= da.convert<Percipio::UInt16>();
}
...
inline Percipio::UInt16 operator *= (Percipio::UInt16& other, const Var& da)
	/// Multiplication asignment operator for multiplying Var with Percipio::UInt16
{
	return other *= da.convert<Percipio::UInt16>();
}
...
inline Percipio::UInt16 operator /= (Percipio::UInt16& other, const Var& da)
	/// Division asignment operator for dividing Var with Percipio::UInt16
{
	return other /= da.convert<Percipio::UInt16>();
}


inline bool operator == (const Percipio::UInt16& other, const Var& da)
	/// Equality operator for comparing Var with Percipio::UInt16
{
	if (da.isEmpty()) return false;
	return other == da.convert<Percipio::UInt16>();
}
...
inline bool operator != (const Percipio::UInt16& other, const Var& da)
	/// Inequality operator for comparing Var with Percipio::UInt16
{
	if (da.isEmpty()) return true;
	return other != da.convert<Percipio::UInt16>();
}
...
inline bool operator < (const Percipio::UInt16& other, const Var& da)
	/// Less than operator for comparing Var with Percipio::UInt16
{
	if (da.isEmpty()) return false;
	return other < da.convert<Percipio::UInt16>();
}
...
inline bool operator <= (const Percipio::UInt16& other, const Var& da)
	/// Less than or equal operator for comparing Var with Percipio::UInt16
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Percipio::UInt16>();
}
...
inline bool operator > (const Percipio::UInt16& other, const Var& da)
	/// Greater than operator for comparing Var with Percipio::UInt16
{
	if (da.isEmpty()) return false;
	return other > da.convert<Percipio::UInt16>();
}
...
inline bool operator >= (const Percipio::UInt16& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Percipio::UInt16
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Percipio::UInt16>();
}
...
inline Percipio::Int32 operator + (const Percipio::Int32& other, const Var& da)
	/// Addition operator for adding Var to Percipio::Int32
{
	return other + da.convert<Percipio::Int32>();
}


inline Percipio::Int32 operator - (const Percipio::Int32& other, const Var& da)
	/// Subtraction operator for subtracting Var from Percipio::Int32
{
	return other - da.convert<Percipio::Int32>();
}
...
inline Percipio::Int32 operator * (const Percipio::Int32& other, const Var& da)
	/// Multiplication operator for multiplying Var with Percipio::Int32
{
	return other * da.convert<Percipio::Int32>();
}
...
inline Percipio::Int32 operator / (const Percipio::Int32& other, const Var& da)
	/// Division operator for dividing Var with Percipio::Int32
{
	return other / da.convert<Percipio::Int32>();
}


inline Percipio::Int32 operator += (Percipio::Int32& other, const Var& da)
	/// Addition asignment operator for adding Var to Percipio::Int32
{
	return other += da.convert<Percipio::Int32>();
}
...
inline Percipio::Int32 operator -= (Percipio::Int32& other, const Var& da)
	/// Subtraction asignment operator for subtracting Var from Percipio::Int32
{
	return other -= da.convert<Percipio::Int32>();
}
...
inline Percipio::Int32 operator *= (Percipio::Int32& other, const Var& da)
	/// Multiplication asignment operator for multiplying Var with Percipio::Int32
{
	return other *= da.convert<Percipio::Int32>();
}
...
inline Percipio::Int32 operator /= (Percipio::Int32& other, const Var& da)
	/// Division asignment operator for dividing Var with Percipio::Int32
{
	return other /= da.convert<Percipio::Int32>();
}


inline bool operator == (const Percipio::Int32& other, const Var& da)
	/// Equality operator for comparing Var with Percipio::Int32
{
	if (da.isEmpty()) return false;
	return other == da.convert<Percipio::Int32>();
}
...
inline bool operator != (const Percipio::Int32& other, const Var& da)
	/// Inequality operator for comparing Var with Percipio::Int32
{
	if (da.isEmpty()) return true;
	return other != da.convert<Percipio::Int32>();
}
...
inline bool operator < (const Percipio::Int32& other, const Var& da)
	/// Less than operator for comparing Var with Percipio::Int32
{
	if (da.isEmpty()) return false;
	return other < da.convert<Percipio::Int32>();
}
...
inline bool operator <= (const Percipio::Int32& other, const Var& da)
	/// Less than or equal operator for comparing Var with Percipio::Int32
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Percipio::Int32>();
}
...
inline bool operator > (const Percipio::Int32& other, const Var& da)
	/// Greater than operator for comparing Var with Percipio::Int32
{
	if (da.isEmpty()) return false;
	return other > da.convert<Percipio::Int32>();
}
...
inline bool operator >= (const Percipio::Int32& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Percipio::Int32
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Percipio::Int32>();
}
...
inline Percipio::UInt32 operator + (const Percipio::UInt32& other, const Var& da)
	/// Addition operator for adding Var to Percipio::UInt32
{
	return other + da.convert<Percipio::UInt32>();
}


inline Percipio::UInt32 operator - (const Percipio::UInt32& other, const Var& da)
	/// Subtraction operator for subtracting Var from Percipio::UInt32
{
	return other - da.convert<Percipio::UInt32>();
}
...
inline Percipio::UInt32 operator * (const Percipio::UInt32& other, const Var& da)
	/// Multiplication operator for multiplying Var with Percipio::UInt32
{
	return other * da.convert<Percipio::UInt32>();
}
...
inline Percipio::UInt32 operator / (const Percipio::UInt32& other, const Var& da)
	/// Division operator for dividing Var with Percipio::UInt32
{
	return other / da.convert<Percipio::UInt32>();
}


inline Percipio::UInt32 operator += (Percipio::UInt32& other, const Var& da)
	/// Addition asignment operator for adding Var to Percipio::UInt32
{
	return other += da.convert<Percipio::UInt32>();
}
...
inline Percipio::UInt32 operator -= (Percipio::UInt32& other, const Var& da)
	/// Subtraction asignment operator for subtracting Var from Percipio::UInt32
{
	return other -= da.convert<Percipio::UInt32>();
}
...
inline Percipio::UInt32 operator *= (Percipio::UInt32& other, const Var& da)
	/// Multiplication asignment operator for multiplying Var with Percipio::UInt32
{
	return other *= da.convert<Percipio::UInt32>();
}
...
inline Percipio::UInt32 operator /= (Percipio::UInt32& other, const Var& da)
	/// Division asignment operator for dividing Var with Percipio::UInt32
{
	return other /= da.convert<Percipio::UInt32>();
}


inline bool operator == (const Percipio::UInt32& other, const Var& da)
	/// Equality operator for comparing Var with Percipio::UInt32
{
	if (da.isEmpty()) return false;
	return other == da.convert<Percipio::UInt32>();
}
...
inline bool operator != (const Percipio::UInt32& other, const Var& da)
	/// Inequality operator for comparing Var with Percipio::UInt32
{
	if (da.isEmpty()) return true;
	return other != da.convert<Percipio::UInt32>();
}
...
inline bool operator < (const Percipio::UInt32& other, const Var& da)
	/// Less than operator for comparing Var with Percipio::UInt32
{
	if (da.isEmpty()) return false;
	return other < da.convert<Percipio::UInt32>();
}
...
inline bool operator <= (const Percipio::UInt32& other, const Var& da)
	/// Less than or equal operator for comparing Var with Percipio::UInt32
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Percipio::UInt32>();
}
...
inline bool operator > (const Percipio::UInt32& other, const Var& da)
	/// Greater than operator for comparing Var with Percipio::UInt32
{
	if (da.isEmpty()) return false;
	return other > da.convert<Percipio::UInt32>();
}
...
inline bool operator >= (const Percipio::UInt32& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Percipio::UInt32
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Percipio::UInt32>();
}
...
inline Percipio::Int64 operator + (const Percipio::Int64& other, const Var& da)
	/// Addition operator for adding Var to Percipio::Int64
{
	return other + da.convert<Percipio::Int64>();
}


inline Percipio::Int64 operator - (const Percipio::Int64& other, const Var& da)
	/// Subtraction operator for subtracting Var from Percipio::Int64
{
	return other - da.convert<Percipio::Int64>();
}
...
inline Percipio::Int64 operator * (const Percipio::Int64& other, const Var& da)
	/// Multiplication operator for multiplying Var with Percipio::Int64
{
	return other * da.convert<Percipio::Int64>();
}
...
inline Percipio::Int64 operator / (const Percipio::Int64& other, const Var& da)
	/// Division operator for dividing Var with Percipio::Int64
{
	return other / da.convert<Percipio::Int64>();
}


inline Percipio::Int64 operator += (Percipio::Int64& other, const Var& da)
	/// Addition asignment operator for adding Var to Percipio::Int64
{
	return other += da.convert<Percipio::Int64>();
}
...
inline Percipio::Int64 operator -= (Percipio::Int64& other, const Var& da)
	/// Subtraction asignment operator for subtracting Var from Percipio::Int64
{
	return other -= da.convert<Percipio::Int64>();
}
...
inline Percipio::Int64 operator *= (Percipio::Int64& other, const Var& da)
	/// Multiplication asignment operator for multiplying Var with Percipio::Int64
{
	return other *= da.convert<Percipio::Int64>();
}
...
inline Percipio::Int64 operator /= (Percipio::Int64& other, const Var& da)
	/// Division asignment operator for dividing Var with Percipio::Int64
{
	return other /= da.convert<Percipio::Int64>();
}


inline bool operator == (const Percipio::Int64& other, const Var& da)
	/// Equality operator for comparing Var with Percipio::Int64
{
	if (da.isEmpty()) return false;
	return other == da.convert<Percipio::Int64>();
}
...
inline bool operator != (const Percipio::Int64& other, const Var& da)
	/// Inequality operator for comparing Var with Percipio::Int64
{
	if (da.isEmpty()) return true;
	return other != da.convert<Percipio::Int64>();
}
...
inline bool operator < (const Percipio::Int64& other, const Var& da)
	/// Less than operator for comparing Var with Percipio::Int64
{
	if (da.isEmpty()) return false;
	return other < da.convert<Percipio::Int64>();
}
...
inline bool operator <= (const Percipio::Int64& other, const Var& da)
	/// Less than or equal operator for comparing Var with Percipio::Int64
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Percipio::Int64>();
}
...
inline bool operator > (const Percipio::Int64& other, const Var& da)
	/// Greater than operator for comparing Var with Percipio::Int64
{
	if (da.isEmpty()) return false;
	return other > da.convert<Percipio::Int64>();
}
...
inline bool operator >= (const Percipio::Int64& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Percipio::Int64
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Percipio::Int64>();
}
...
inline Percipio::UInt64 operator + (const Percipio::UInt64& other, const Var& da)
	/// Addition operator for adding Var to Percipio::UInt64
{
	return other + da.convert<Percipio::UInt64>();
}


inline Percipio::UInt64 operator - (const Percipio::UInt64& other, const Var& da)
	/// Subtraction operator for subtracting Var from Percipio::UInt64
{
	return other - da.convert<Percipio::UInt64>();
}
...
inline Percipio::UInt64 operator * (const Percipio::UInt64& other, const Var& da)
	/// Multiplication operator for multiplying Var with Percipio::UInt64
{
	return other * da.convert<Percipio::UInt64>();
}
...
inline Percipio::UInt64 operator / (const Percipio::UInt64& other, const Var& da)
	/// Division operator for dividing Var with Percipio::UInt64
{
	return other / da.convert<Percipio::UInt64>();
}


inline Percipio::UInt64 operator += (Percipio::UInt64& other, const Var& da)
	/// Addition asignment operator for adding Var to Percipio::UInt64
{
	return other += da.convert<Percipio::UInt64>();
}
...
inline Percipio::UInt64 operator -= (Percipio::UInt64& other, const Var& da)
	/// Subtraction asignment operator for subtracting Var from Percipio::UInt64
{
	return other -= da.convert<Percipio::UInt64>();
}
...
inline Percipio::UInt64 operator *= (Percipio::UInt64& other, const Var& da)
	/// Multiplication asignment operator for multiplying Var with Percipio::UInt64
{
	return other *= da.convert<Percipio::UInt64>();
}
...
inline Percipio::UInt64 operator /= (Percipio::UInt64& other, const Var& da)
	/// Division asignment operator for dividing Var with Percipio::UInt64
{
	return other /= da.convert<Percipio::UInt64>();
}


inline bool operator == (const Percipio::UInt64& other, const Var& da)
	/// Equality operator for comparing Var with Percipio::UInt64
{
	if (da.isEmpty()) return false;
	return other == da.convert<Percipio::UInt64>();
}
...
inline bool operator != (const Percipio::UInt64& other, const Var& da)
	/// Inequality operator for comparing Var with Percipio::UInt64
{
	if (da.isEmpty()) return true;
	return other != da.convert<Percipio::UInt64>();
}
...
inline bool operator < (const Percipio::UInt64& other, const Var& da)
	/// Less than operator for comparing Var with Percipio::UInt64
{
	if (da.isEmpty()) return false;
	return other < da.convert<Percipio::UInt64>();
}
...
inline bool operator <= (const Percipio::UInt64& other, const Var& da)
	/// Less than or equal operator for comparing Var with Percipio::UInt64
{
	if (da.isEmpty()) return false;
	return other <= da.convert<Percipio::UInt64>();
}
...
inline bool operator > (const Percipio::UInt64& other, const Var& da)
	/// Greater than operator for comparing Var with Percipio::UInt64
{
	if (da.isEmpty()) return false;
	return other > da.convert<Percipio::UInt64>();
}
...
inline bool operator >= (const Percipio::UInt64& other, const Var& da)
	/// Greater than or equal operator for comparing Var with Percipio::UInt64
{
	if (da.isEmpty()) return false;
	return other >= da.convert<Percipio::UInt64>();
}
...
#ifndef PERCIPIO_LONG_IS_64_BIT
