...
// VarIterator.h
//
// $Id: //percipio/Main/Foundation/include/Percipio/Dynamic/VarIterator.h#1 $
//
// Library: Foundation
// Package: Dynamic
// Module:  VarIterator
...
namespace std
{
	using std::swap;
	template<>
	inline void swap<Percipio::Dynamic::VarIterator>(Percipio::Dynamic::VarIterator& s1, 
		Percipio::Dynamic::VarIterator& s2)
