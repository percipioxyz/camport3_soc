...
// Checksum.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/Checksum.h#1 $
//
// Library: Foundation
// Package: Core
// Module:  Checksum
...
public:
	...
	Percipio::UInt32 checksum() const;
...
inline Percipio::UInt32 Checksum::checksum() const
{
	return _value;
}
