...
// Optional.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/Optional.h#1 $
//
// Library: Foundation
// Package: Core
// Module:  Optional
...
public:
	...
	const C& value() const
		...
		///
		/// Throws a Percipio::NullValueException if the value has not been specified.
	{
		if (_isSpecified)
			return _value;
		else
			throw Percipio::NullValueException();
	}
