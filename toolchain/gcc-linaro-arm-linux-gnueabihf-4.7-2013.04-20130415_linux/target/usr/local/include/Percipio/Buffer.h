...
// Buffer.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/Buffer.h#2 $
//
// Library: Foundation
// Package: Core
// Module:  Buffer
...
public:
	...
	void resize(std::size_t newCapacity, bool preserveContent = true)
		...
		/// is thrown.
	{
		if (!_ownMem) throw Percipio::InvalidAccessException("Cannot resize buffer which does not own its storage.");
