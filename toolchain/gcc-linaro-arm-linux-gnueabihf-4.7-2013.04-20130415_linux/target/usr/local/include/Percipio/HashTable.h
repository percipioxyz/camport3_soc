...
// HashTable.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/HashTable.h#1 $
//
// Library: Foundation
// Package: Hashing
// Module:  HashTable
...
#include "Percipio/HashFunction.h"
#include "Percipio/HashStatistic.h"
#include <vector>
#include <map>
#include <cstddef>
#include <cstring>
...
public:
	...
	HashTable& operator = (const HashTable& ht)
	{
		if (this != &ht)
		{
			clear();
			_maxCapacity = ht._maxCapacity;
			percipio_assert_dbg (_entries == 0);
	...
	#ifdef _DEBUG
		percipio_assert_dbg(totalSize == numberOfEntries);
	#endif
