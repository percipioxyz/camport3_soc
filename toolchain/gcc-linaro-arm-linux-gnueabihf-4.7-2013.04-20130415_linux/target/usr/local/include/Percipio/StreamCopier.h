...
// StreamCopier.h
//
// $Id: //percipio/1.4/Foundation/include/Percipio/StreamCopier.h#2 $
//
// Library: Foundation
// Package: Streams
// Module:  StreamCopier
...
public:
	...
	static Percipio::UInt64 copyStream64(std::istream& istr, std::ostream& ostr, std::size_t bufferSize = 8192);
		/// Writes all bytes readable from istr to ostr, using an internal buffer.
		///
...
#if defined(PERCIPIO_HAVE_INT64)
	static Percipio::UInt64 copyStreamUnbuffered64(std::istream& istr, std::ostream& ostr);
		/// Writes all bytes readable from istr to ostr.
		///
		/// Returns the number of bytes copied as a 64-bit unsigned integer.
		///
...
#if defined(PERCIPIO_HAVE_INT64)
	static Percipio::UInt64 copyToString64(std::istream& istr, std::string& str, std::size_t bufferSize = 8192);
		/// Appends all bytes readable from istr to the given string, using an internal buffer.
		///
		/// Returns the number of bytes copied as a 64-bit unsigned integer.
		///
